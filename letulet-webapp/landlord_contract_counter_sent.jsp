...
<div id="wrap" class="container animated fadeInDown">
    ...
    <div class="col-md-6 col-md-offset-3">
        ...
        <div class="page-header">
            <h3>Congratulations !! Your counter offer is sent.</h3>
        </div>

        <p>Lorem ipsum....</p>
        <p>Normal respond from tenant is within 48 hours. Check your proposal status by <a href="#">logging in to your dashboard</a>.</p>
