...
<%@ page contentType="text/html; charset=UTF-8" pageEncoding="utf-8" %><%
    ...
    String previouspage = request.getContextPath() + "/landlord_contract_decline.jsp";
    ...
    try {
        ...
        agreement.save();
        response.sendRedirect(request.getContextPath() + "/landlord_contract_declined.jsp?uid=" + uid);
