                    ...
                    <div class="col-xs-12 text-center">
                        ...
                        <div class="row">
                            <div class="col-xs-offset-2 col-xs-8">
                                <form id="signinform" onsubmit="return signTenant(this)">

                                    <div class="form-group required">
                                        <label class="sr-only" for="email"></label>
                                        <input name="data[Tenant][email]" placeholder="Email"  type="email" class="form-control" id="email" required>
                                    </div>

                                    <div class="text-left form-group required">
                                        <label class="sr-only" for="password"></label>
                                        <input name="data[Tenant][password]" placeholder="Password" type="password" autocomplete="off" class="form-control" id="password" required>
                                    </div>

                                    <div class="form-group required">
                                        <label class="sr-only" for="firstName"></label>
                                        <input name="data[Tenant][firstName]" placeholder="First Name" type="text" autocomplete="off" class="form-control" id="firstName" required>
                                    </div>

                                    <div class="form-group required">
                                        <label class="sr-only" for="lastName"></label>
                                        <input name="data[Tenant][lastName]" placeholder="Last Name"  type="text" autocomplete="off" class="form-control" id="lastName" required>
                                    </div>
